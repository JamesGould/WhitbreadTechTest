...
public class AppiumUtil extends Constants {
	...
	public static void startApp() throws MalformedURLException {		
		driver=new AndroidDriver(new URL("http://0.0.0.0:4723/wd/hub"), getDesiredCapabiltiesForAndroid());
	}
	...
	public static void tap_button(AndroidElement element) {
		waitUntillTappable(element);
